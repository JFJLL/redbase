...
const SAFE_CLIENT_PAYLOAD_KEYS = new Set([
  ...
  "projectId", "videoModel", "videoMode", "videoResolution", "videoStatus", "finalVideoUrl", "finalPosterUrl", "videoClips", "script", "visualBible",
  "model", "generationDurationSec", "dependsOnClipIndex", "continuityMode", "referenceAssetIds", "continuityState", "creditCost", "attempt", "retryCount", "videoUrl", "posterUrl", "continuityFrameUrl", "estimatedCredits", "chargedCredits", "refundedCredits", "prompt",
